...

{
  ...
  $exemplaire_dispo=$_POST['exemplaire_dispo'];
  $annee_publication=$_POST['annee_publication'];
  

  if($titre_livre!="" && $auteur!="" && $id_livre!="" && $nombre_exemplaire!="" && $exemplaire_dispo!="" && $annee_publication!="" )

        $insert="INSERT INTO `livres`(`titre_livre`,`auteur`,`id_livre`,`nombre_exemplaire`,`exemplaire_dispo`,`categorie`,`annee_publication`) VALUES('".$titre_livre."','".$auteur."','".$id_livre."','".$nombre_exemplaire."','".$exemplaire_dispo."','".$categorie."','".$annee_publication."')";
...
<form action="" method="POST" enctype="multipart/form-data">
  <div class = "">
    <div class="">
    <h2 style="text-align: center;">Ajouter livre</h2>
      </div>
  ...
  <tr>
    <td>exemplaire_dispo</td>
   <td><input type="text" name="exemplaire_dispo" placeholder="exemplaire_dispo"/></td>
  </tr>
  <tr>
   ...
   <select name="categorie">
     ...
     <option value="bdd">Base de donnée</option>
      ...
      <tr>
    <td><h2><input style="margin-left:180%;margin-top:10%;" type="submit" name="sub" value="Ajouter"/></h2></td>
